...
import org.happinessmeta.last.resume.dto.sub.ProjectSummaryDto;
...
public record CreateResumeDto(
    ...
    public Resume toEntity() {
        return Resume.builder()
                ...
                .projectSummary(projectSummary.stream().map(ProjectSummaryDto::toEntity).collect(Collectors.toList()))
                .build();
    }
}
